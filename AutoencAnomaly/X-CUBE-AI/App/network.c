...
#define AI_NETWORK_MODEL_SIGNATURE     "1544f788ad6974481edcd898cfc9c648"
...
#define AI_TOOLS_DATE_TIME   "Wed Jul 13 12:49:58 2022"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_input_60_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  nl_1_nl_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 3, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  serving_default_input_60_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 3, 1, 1), AI_STRIDE_INIT(4, 4, 4, 12, 12),
  1, &serving_default_input_60_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 3, 2, 1, 1), AI_STRIDE_INIT(4, 4, 12, 24, 24),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 2, 3, 1, 1), AI_STRIDE_INIT(4, 4, 8, 24, 24),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_input_60_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    68, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 20, 1, 1),
    20, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_input_60_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_1_nl_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    dense_1_output_array.data = AI_PTR(activations_map[0] + 8);
    dense_1_output_array.data_start = AI_PTR(activations_map[0] + 8);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_0_bias_array.data = AI_PTR(weights_map[0] + 24);
    dense_0_bias_array.data_start = AI_PTR(weights_map[0] + 24);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights_map[0] + 32);
    dense_1_weights_array.data_start = AI_PTR(weights_map[0] + 32);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights_map[0] + 56);
    dense_1_bias_array.data_start = AI_PTR(weights_map[0] + 56);
    return true;
  }
