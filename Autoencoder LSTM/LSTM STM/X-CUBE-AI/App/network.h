...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "lstm_model"
...
#define AI_NETWORK_IN_1_SIZE        (32 * 3)
#define AI_NETWORK_IN_1_SIZE_BYTES  (384)
...
#define AI_NETWORK_OUT_1_HEIGHT      (32)
#define AI_NETWORK_OUT_1_CHANNEL     (3)
#define AI_NETWORK_OUT_1_SIZE        (32 * 3)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (384)
